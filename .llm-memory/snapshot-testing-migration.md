...
## Important Rule
**Always refer back to reference Reflaxe compilers** at `/REDACTED_LOCAL_PATH` periodically to ensure our implementation follows established patterns. Both Reflaxe.CPP and Reflaxe.CSharp use the same snapshot testing approach with:
