...
E2E_SPEC="e2e/basic.spec.ts e2e/oauth_mock.spec.ts e2e/search.spec.ts e2e/tags_sort.spec.ts e2e/live_updates.spec.ts e2e/create_todo.spec.ts e2e/edit_todo.spec.ts"
