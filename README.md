...
[![Version](https://img.shields.io/badge/version-0.14.24-blue)](https://github.com/fullofcaffeine/reflaxe.elixir/releases)
...
> [!WARNING]
> **Stability**: v0.14.24 is on the pre-1.0 (`v0.x`) release line.
