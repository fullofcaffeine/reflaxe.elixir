...
var vNullInt = #if elixir_output null #elseif static 0 #else null #end;
var vNullBool = #if elixir_output null #elseif static false #else null #end;
var vNullFloat = #if elixir_output null #elseif static 0.0 #else null #end;
vec.length == 3;
vec.get(0) == vNullInt;
vec.get(1) == vNullInt;
vec.get(2) == vNullInt;
...
// objects
var tpl = {id: 1};
var vec:haxe.ds.Vector<{id:Int}> = haxe.ds.Vector.fromArrayCopy([tpl]);
tpl == vec.get(0);
// toData + fromData
...
var i1 = {value: 1};
var i2 = {value: 5};
var vec = new haxe.ds.Vector<{value:Int}>(3);
vec[0] = i0;
vec[1] = i1;
vec[2] = i2;
var vec2 = vec.copy();
