...
- **2026-09-25 positive inventory: 441 active fixtures**, including abstract identity values in functions, conditional factories, and switch branches, also exercised by the native runtime smoke suite.
