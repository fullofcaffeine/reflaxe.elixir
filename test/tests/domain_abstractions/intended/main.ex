defmodule Main do
  ...
  @doc "Generated from Haxe testEmailValidation"
  ...
  @doc "Generated from Haxe testUserIdValidation"
  ...
  @doc "Generated from Haxe testPositiveIntArithmetic"
  ...
  @doc "Generated from Haxe testNonEmptyStringOperations"
  ...
  @doc "Generated from Haxe testErrorHandling"
  ...
  def build_user_profile(user_id_str, email_str, score_str) do
    ...
    ResultTools.flat_map(ResultTools.map_error(UserId_Impl_.parse(user_id_str), fn e -> "Invalid UserId: " <> e end), fn user_id -> ResultTools.flat_map(ResultTools.map_error(Email_Impl_.parse(StringTools.trim(email_str)), fn e -> "Invalid Email: " <> e end), fn email -> score_int = Std.parse_int(score_str)
    if ((score_int == nil)) do
  ...
  @doc "Generated from Haxe validateConfiguration"
