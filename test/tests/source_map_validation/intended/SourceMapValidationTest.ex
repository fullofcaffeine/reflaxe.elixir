...
Log.trace("=== Test Complete ===", %{fileName: "SourceMapValidationTest.hx", lineNumber: 53, className: "SourceMapValidationTest", methodName: "main"})
  ...
  def test_function(arg0, arg1) do
    Log.trace("Testing with: " <> arg0 <> " and " <> arg1, %{fileName: "SourceMapValidationTest.hx", lineNumber: 57, className: "SourceMapValidationTest", methodName: "testFunction"})
  end

  @doc "Function process_item"
  @spec process_item(integer()) :: nil
  def process_item(arg0) do
    Log.trace("Processing item: " <> arg0, %{fileName: "SourceMapValidationTest.hx", lineNumber: 61, className: "SourceMapValidationTest", methodName: "processItem"})
  end
