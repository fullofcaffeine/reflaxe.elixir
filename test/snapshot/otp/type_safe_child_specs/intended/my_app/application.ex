defmodule TestApp.Application do
  ...
  defp test_application_children() do
    ...
    _type_safe_children_1 = {TestApp.Repo, config}
    _ = TestAppWeb.Endpoint
    _ = TestApp.Telemetry
    args = [%{name: "TestApp.Presence", pubsub_server: "TestApp.PubSub"}]
    _type_safe_children_4 = if (length(args) > 0), do: {TestApp.Presence, args}, else: TestApp.Presence
