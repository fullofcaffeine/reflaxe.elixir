defmodule Main do
  ...
  if (acc_k <= 5) do
    ...
    total = 0
    x = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {total, x, y, :ok}, fn _, {acc_total, acc_x, acc_y, acc_state} ->
  if (acc_x < 3) do
    acc_y = 0
  ...
  if (acc_y < 3) do
    ...
    acc_x = acc_x + 1
    {:cont, {acc_total, acc_x, acc_y, acc_state}}
  else
    {:halt, {acc_total, acc_x, acc_y, acc_state}}
  end
end)
