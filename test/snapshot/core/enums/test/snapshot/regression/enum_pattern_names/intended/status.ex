defmodule Status do
  ...
  def __haxe_enum_create_by_name__(constructor, params) do
    ...
    case constructor do
      ...
      "Error" -> raise "Enum constructor Error expects 2 params for Status"
      "Processing" when values == [] -> List.to_tuple([:processing | values])
      "Processing" -> raise "Enum constructor Processing expects 0 params for Status"
  ...
  def __haxe_enum_create_by_index__(index, params) do
    ...
    case index do
      ...
      0 -> raise "Enum constructor Success expects 1 params for Status"
      1 when length(values) == 2 -> List.to_tuple([:error | values])
      1 -> raise "Enum constructor Error expects 2 params for Status"
      2 when values == [] -> List.to_tuple([:processing | values])
      2 -> raise "Enum constructor Processing expects 0 params for Status"
