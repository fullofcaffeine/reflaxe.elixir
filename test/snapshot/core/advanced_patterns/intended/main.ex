defmodule Main do
  ...
  def main() do
    ...
    Log.trace(Main.classify_number(0), %{:fileName => "Main.hx", :lineNumber => 224, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(0.5), %{:fileName => "Main.hx", :lineNumber => 225, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(5), %{:fileName => "Main.hx", :lineNumber => 226, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(50), %{:fileName => "Main.hx", :lineNumber => 227, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(500), %{:fileName => "Main.hx", :lineNumber => 228, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(5000), %{:fileName => "Main.hx", :lineNumber => 229, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(-5), %{:fileName => "Main.hx", :lineNumber => 230, :className => "Main", :methodName => "main"})
    Log.trace(Main.classify_number(-50), %{:fileName => "Main.hx", :lineNumber => 231, :className => "Main", :methodName => "main"})
