defmodule StringUtils do
  ...
  if (acc_g < acc_g1) do
    ...
    g = 0
    g1 = masked_count
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {masked, g, g1, :ok}, fn _, {acc_masked, acc_g, acc_g1, acc_state} ->
  if (acc_g < acc_g1) do
    _i = acc_g = acc_g + 1
    acc_masked = acc_masked <> "*"
    {:cont, {acc_masked, acc_g, acc_g1, acc_state}}
  else
    {:halt, {acc_masked, acc_g, acc_g1, acc_state}}
  end
end)
    visible <> masked
  end
