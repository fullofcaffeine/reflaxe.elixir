defmodule Main do
  ...
  try do
    ...
    e ->
      Log.trace("Caught dynamic: " <> Std.string(e), %{:file_name => "Main.hx", :line_number => 45, :class_name => "Main", :method_name => "multipleCatch"})
  end
end
    test_error.(1)
    test_error.(2)
  ...
  e ->
    ...
    Log.trace("Parsed value: " <> Kernel.to_string(value), %{:file_name => "Main.hx", :line_number => 169, :class_name => "Main", :method_name => "tryAsExpression"})
    value2 = try do
  ...
  e ->
    ...
    Log.trace("Failed parse value: " <> Kernel.to_string(value2), %{:file_name => "Main.hx", :line_number => 176, :class_name => "Main", :method_name => "tryAsExpression"})
  end
  def main() do
