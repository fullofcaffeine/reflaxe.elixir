defmodule Main do
  def main() do
    ...
    _has_even = MapTools.any(numbers, fn _k, v -> rem(v, 2) == 0 end)
    _all_positive = MapTools.all(numbers, fn _k, v -> v > 0 end)
    _sum = Enum.reduce(numbers, 0, fn acc, _k, v -> acc + v end)
