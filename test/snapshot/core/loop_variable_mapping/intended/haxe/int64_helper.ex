defmodule Int64Helper do
  ...
  def parse_string(s_param) do
    ...
    g = 0
    g1 = len
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {p10, b_low, b_high, low, b_low, this1, g, digit_low, low, high, this1, p01, digit_high, b_high, low, g1, high, high, high, p10, p10, multiplier, p01, high, current, p01, this1, :ok}, fn _, {acc_p10, acc_b_low, acc_b_high, acc_low, acc_b_low, acc_this1, acc_g, acc_digit_low, acc_low, acc_high, acc_this1, acc_p01, acc_digit_high, acc_b_high, acc_low, acc_g1, acc_high, acc_high, acc_high, acc_p10, acc_p10, acc_multiplier, acc_p01, acc_high, acc_current, acc_p01, acc_this1, acc_state} ->
  if (acc_g < acc_g1) do
    i = acc_g = acc_g + 1
...
if Int32_Impl_.ucompare(acc_low, acc_p10) < 0, do: ret
acc_this1
    {:cont, {acc_p10, acc_b_low, acc_b_high, acc_low, acc_b_low, acc_this1, acc_g, acc_digit_low, acc_low, acc_high, acc_this1, acc_p01, acc_digit_high, acc_b_high, acc_low, acc_g1, acc_high, acc_high, acc_high, acc_p10, acc_p10, acc_multiplier, acc_p01, acc_high, acc_current, acc_p01, acc_this1, acc_state}}
  else
    {:halt, {acc_p10, acc_b_low, acc_b_high, acc_low, acc_b_low, acc_this1, acc_g, acc_digit_low, acc_low, acc_high, acc_this1, acc_p01, acc_digit_high, acc_b_high, acc_low, acc_g1, acc_high, acc_high, acc_high, acc_p10, acc_p10, acc_multiplier, acc_p01, acc_high, acc_current, acc_p01, acc_this1, acc_state}}
  end
end)
    current
  end
  ...
  no_fractions
    ...
    i = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {a_low, result, this1, this1, this1, this1, a_high, i, rest, b, high, :ok}, fn _, {acc_a_low, acc_result, acc_this1, acc_this1, acc_this1, acc_this1, acc_a_high, acc_i, acc_rest, acc_b, acc_high, acc_state} ->
  if (acc_rest >= 1) do
    curr = acc_rest rem 2
    acc_rest = acc_rest / 2
    if (curr >= 1) do
...
acc_this1
    ...
    acc_i = acc_i + 1
    {:cont, {acc_a_low, acc_result, acc_this1, acc_this1, acc_this1, acc_this1, acc_a_high, acc_i, acc_rest, acc_b, acc_high, acc_state}}
  else
    {:halt, {acc_a_low, acc_result, acc_this1, acc_this1, acc_this1, acc_this1, acc_a_high, acc_i, acc_rest, acc_b, acc_high, acc_state}}
  end
end)
    if neg do
      high = ~~~result.high
