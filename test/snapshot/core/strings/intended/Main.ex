defmodule Main do
  def string_basics() do
    ...
    Log.trace("Length of \"#{str3}\": #{length(str3)}", %{:file_name => "Main.hx", :line_number => 24, :class_name => "Main", :method_name => "stringBasics"})
  end
...
case String.split(sub, "o") do
  ...
  def string_comparison() do
    ...
    str3 = "apple"
    str4 = "banana"
    Log.trace("str1 == str3: #{inspect(str1 == str3)}", %{:file_name => "Main.hx", :line_number => 94, :class_name => "Main", :method_name => "stringComparison"})
    Log.trace("str1 == str2: #{inspect(str1 == str2)}", %{:file_name => "Main.hx", :line_number => 95, :class_name => "Main", :method_name => "stringComparison"})
    if str1 < str4 do
  ...
  def string_building() do
    buf = StringBuf.new()
    StringBuf.add(buf, "Building ")
    StringBuf.add(buf, "a ")
    StringBuf.add(buf, "string ")
    StringBuf.add(buf, "efficiently")
    StringBuf.add(buf, "!")
    StringBuf.add(buf, "!")
    StringBuf.add(buf, "!")
    ...
    parts = []
    %{struct | parts: struct.parts ++ ["Item #{1}"]}
    %{struct | parts: struct.parts ++ ["Item #{2}"]}
    %{struct | parts: struct.parts ++ ["Item #{3}"]}
    %{struct | parts: struct.parts ++ ["Item #{4}"]}
    %{struct | parts: struct.parts ++ ["Item #{5}"]}
  ...
  if all_numbers.match(text) do
    ...
    Log.trace("Is valid email: #{inspect(email_regex.match(email))}", %{:file_name => "Main.hx", :line_number => 160, :class_name => "Main", :method_name => "regexOperations"})
  end
  ...
  def unicode_strings() do
    ...
    Log.trace("Length: #{length(unicode)}", %{:file_name => "Main.hx", :line_number => 190, :class_name => "Main", :method_name => "unicodeStrings"})
    escaped = "Line 1\nLine 2\tTabbed\r\nLine 3"
