defmodule Main do
  defp main() do
    ...
    Log.trace("Price1: $" <> Money_Impl_.to_dollars(price1), %{:fileName => "Main.hx", :lineNumber => 83, :className => "Main", :methodName => "main"})
    Log.trace("Price2: $" <> Money_Impl_.to_dollars(price2), %{:fileName => "Main.hx", :lineNumber => 84, :className => "Main", :methodName => "main"})
