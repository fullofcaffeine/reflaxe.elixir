...
g
  ...
  Log.trace("  " + key + " => " + value, %{:fileName => "Main.hx", :lineNumber => 139, :className => "Main", :methodName => "testMapTransformations"})
  {:cont, acc}
else
  {:halt, acc}
end end)
  ...
  Log.trace("  " + key + " => " + value, %{:fileName => "Main.hx", :lineNumber => 157, :className => "Main", :methodName => "testMapTransformations"})
  {:cont, acc}
else
  {:halt, acc}
end end)
