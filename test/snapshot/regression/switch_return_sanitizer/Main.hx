...
class SwitchReturnTest {
	 ...
	 */
	public static function mapOrElse<T, U>(result:Result<T, String>, mapFn:(T) -> U, elseFn:() -> U):U {
		return switch (result) {
...
class Main {
	static function main() {
		...
		var r5 = SwitchReturnTest.mapOrElse(testResult, function(x) return x * 2, function() return -1);
