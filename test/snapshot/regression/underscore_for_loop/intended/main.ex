defmodule Main do
  def main() do
    ...
    rows = 0
    g = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {matrix, rows, g, cols, :ok}, fn _, {acc_matrix, acc_rows, acc_g, acc_cols, acc_state} ->
  if (acc_g < acc_matrix.length) do
    ...
    {:cont, {acc_matrix, acc_rows, acc_g, acc_cols, acc_state}}
  else
    {:halt, {acc_matrix, acc_rows, acc_g, acc_cols, acc_state}}
  end
end)
