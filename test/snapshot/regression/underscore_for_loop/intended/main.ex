defmodule Main do
  def main() do
    ...
    rows = 0
    g = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {g, cols, matrix, rows, :ok}, fn _, {acc_g, acc_cols, acc_matrix, acc_rows, acc_state} ->
  if (acc_g < acc_matrix.length) do
    ...
    {:cont, {acc_g, acc_cols, acc_matrix, acc_rows, acc_state}}
  else
    {:halt, {acc_g, acc_cols, acc_matrix, acc_rows, acc_state}}
  end
end)
