defmodule Main do
  def main() do
    ...
    Log.trace("age: " <> age.to_string(), %{:file_name => "Main.hx", :line_number => 54, :class_name => "Main", :method_name => "main"})
    Log.trace("hasZ after setField: " <> Std.string(has_z), %{:file_name => "Main.hx", :line_number => 56, :class_name => "Main", :method_name => "main"})
    Log.trace("zValue: " <> z_value.to_string(), %{:file_name => "Main.hx", :line_number => 57, :class_name => "Main", :method_name => "main"})
    Log.trace("hasB after deleteField: " <> Std.string(has_b), %{:file_name => "Main.hx", :line_number => 59, :class_name => "Main", :method_name => "main"})
    Log.trace("fields length: " <> fields.length.to_string(), %{:file_name => "Main.hx", :line_number => 61, :class_name => "Main", :method_name => "main"})
