defmodule Color do
  ...
  def __haxe_enum_create_by_name__(constructor, params) do
    ...
    case constructor do
      ...
      "Hex" when length(values) == 1 -> List.to_tuple([:hex | values])
      "Hex" -> raise "Enum constructor Hex expects 1 params for Color"
  ...
  def __haxe_enum_create_by_index__(index, params) do
    ...
    case index do
      ...
      3 when length(values) == 1 -> List.to_tuple([:hex | values])
      3 -> raise "Enum constructor Hex expects 1 params for Color"
