defmodule Int64Helper do
  ...
  def parse_string(s_param) do
    ...
    g = 0
    g1 = len
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {p10, digit_low, high, low, digit_high, high, b_low, p01, high, p01, this1, p10, p01, b_high, high, b_high, low, multiplier, high, p10, current, b_low, g1, g, low, this1, this1, :ok}, fn _, {acc_p10, acc_digit_low, acc_high, acc_low, acc_digit_high, acc_high, acc_b_low, acc_p01, acc_high, acc_p01, acc_this1, acc_p10, acc_p01, acc_b_high, acc_high, acc_b_high, acc_low, acc_multiplier, acc_high, acc_p10, acc_current, acc_b_low, acc_g1, acc_g, acc_low, acc_this1, acc_this1, acc_state} ->
  if (acc_g < acc_g1) do
    i = acc_g = acc_g + 1
...
if Int32_Impl_.ucompare(acc_low, acc_p10) < 0, do: ret
acc_this1
    {:cont, {acc_p10, acc_digit_low, acc_high, acc_low, acc_digit_high, acc_high, acc_b_low, acc_p01, acc_high, acc_p01, acc_this1, acc_p10, acc_p01, acc_b_high, acc_high, acc_b_high, acc_low, acc_multiplier, acc_high, acc_p10, acc_current, acc_b_low, acc_g1, acc_g, acc_low, acc_this1, acc_this1, acc_state}}
  else
    {:halt, {acc_p10, acc_digit_low, acc_high, acc_low, acc_digit_high, acc_high, acc_b_low, acc_p01, acc_high, acc_p01, acc_this1, acc_p10, acc_p01, acc_b_high, acc_high, acc_b_high, acc_low, acc_multiplier, acc_high, acc_p10, acc_current, acc_b_low, acc_g1, acc_g, acc_low, acc_this1, acc_this1, acc_state}}
  end
end)
    current
  end
  ...
  no_fractions
    ...
    i = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {high, rest, this1, this1, a_low, this1, b, this1, result, i, a_high, :ok}, fn _, {acc_high, acc_rest, acc_this1, acc_this1, acc_a_low, acc_this1, acc_b, acc_this1, acc_result, acc_i, acc_a_high, acc_state} ->
  if (acc_rest >= 1) do
    curr = acc_rest rem 2
    acc_rest = acc_rest / 2
    if (curr >= 1) do
...
acc_this1
    ...
    acc_i = acc_i + 1
    {:cont, {acc_high, acc_rest, acc_this1, acc_this1, acc_a_low, acc_this1, acc_b, acc_this1, acc_result, acc_i, acc_a_high, acc_state}}
  else
    {:halt, {acc_high, acc_rest, acc_this1, acc_this1, acc_a_low, acc_this1, acc_b, acc_this1, acc_result, acc_i, acc_a_high, acc_state}}
  end
end)
    if neg do
      high = ~~~result.high
