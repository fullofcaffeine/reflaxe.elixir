defmodule Int64Helper do
  ...
  def parse_string(s_param) do
    ...
    g = 0
    g1 = len
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {p10, high, low, p01, this1, b_low, this1, high, p01, p10, current, high, this1, p01, low, g, b_low, p10, b_high, b_high, g1, digit_high, digit_low, high, high, multiplier, low, :ok}, fn _, {acc_p10, acc_high, acc_low, acc_p01, acc_this1, acc_b_low, acc_this1, acc_high, acc_p01, acc_p10, acc_current, acc_high, acc_this1, acc_p01, acc_low, acc_g, acc_b_low, acc_p10, acc_b_high, acc_b_high, acc_g1, acc_digit_high, acc_digit_low, acc_high, acc_high, acc_multiplier, acc_low, acc_state} ->
  if (acc_g < acc_g1) do
    i = acc_g = acc_g + 1
...
if Int32_Impl_.ucompare(acc_low, acc_p10) < 0, do: ret
acc_this1
    {:cont, {acc_p10, acc_high, acc_low, acc_p01, acc_this1, acc_b_low, acc_this1, acc_high, acc_p01, acc_p10, acc_current, acc_high, acc_this1, acc_p01, acc_low, acc_g, acc_b_low, acc_p10, acc_b_high, acc_b_high, acc_g1, acc_digit_high, acc_digit_low, acc_high, acc_high, acc_multiplier, acc_low, acc_state}}
  else
    {:halt, {acc_p10, acc_high, acc_low, acc_p01, acc_this1, acc_b_low, acc_this1, acc_high, acc_p01, acc_p10, acc_current, acc_high, acc_this1, acc_p01, acc_low, acc_g, acc_b_low, acc_p10, acc_b_high, acc_b_high, acc_g1, acc_digit_high, acc_digit_low, acc_high, acc_high, acc_multiplier, acc_low, acc_state}}
  end
end)
    current
  end
  ...
  no_fractions
    ...
    i = 0
    Enum.reduce_while(Stream.iterate(0, fn n -> n + 1 end), {a_low, this1, rest, this1, i, result, b, this1, high, this1, a_high, :ok}, fn _, {acc_a_low, acc_this1, acc_rest, acc_this1, acc_i, acc_result, acc_b, acc_this1, acc_high, acc_this1, acc_a_high, acc_state} ->
  if (acc_rest >= 1) do
    curr = acc_rest rem 2
    acc_rest = acc_rest / 2
    if (curr >= 1) do
...
acc_this1
    ...
    acc_i = acc_i + 1
    {:cont, {acc_a_low, acc_this1, acc_rest, acc_this1, acc_i, acc_result, acc_b, acc_this1, acc_high, acc_this1, acc_a_high, acc_state}}
  else
    {:halt, {acc_a_low, acc_this1, acc_rest, acc_this1, acc_i, acc_result, acc_b, acc_this1, acc_high, acc_this1, acc_a_high, acc_state}}
  end
end)
    if neg do
      high = ~~~result.high
