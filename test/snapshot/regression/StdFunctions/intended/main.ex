defmodule Main do
  ...
  defp test_parsing() do
    ...
    Log.trace("  Valid: #{valid_int}", %{:file_name => "Main.hx", :line_number => 58, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Negative: #{negative_int}", %{:file_name => "Main.hx", :line_number => 59, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Invalid: #{invalid_int}", %{:file_name => "Main.hx", :line_number => 60, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Partial: #{partial_int}", %{:file_name => "Main.hx", :line_number => 61, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Empty: #{empty_int}", %{:file_name => "Main.hx", :line_number => 62, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("Float parsing:", %{:file_name => "Main.hx", :line_number => 64, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Valid: #{valid_float}", %{:file_name => "Main.hx", :line_number => 65, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Negative: #{negative_float}", %{:file_name => "Main.hx", :line_number => 66, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Int as float: #{int_as_float}", %{:file_name => "Main.hx", :line_number => 67, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Invalid: #{invalid_float}", %{:file_name => "Main.hx", :line_number => 68, :class_name => "Main", :method_name => "testParsing"})
    Log.trace("  Partial: #{partial_float}", %{:file_name => "Main.hx", :line_number => 69, :class_name => "Main", :method_name => "testParsing"})
  end
  defp test_type_checking() do
    ...
    Log.trace("  String is String: #{str_is_string}", %{:file_name => "Main.hx", :line_number => 103, :class_name => "Main", :method_name => "testTypeChecking"})
    Log.trace("  Array is Array: #{arr_is_array}", %{:file_name => "Main.hx", :line_number => 104, :class_name => "Main", :method_name => "testTypeChecking"})
  ...
  defp test_random_and_int() do
    ...
    Log.trace("  Random 1: #{rand1}", %{:file_name => "Main.hx", :line_number => 126, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  Random 2: #{rand2}", %{:file_name => "Main.hx", :line_number => 127, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  Random 3: #{rand3}", %{:file_name => "Main.hx", :line_number => 128, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("Float truncation with Std.int():", %{:file_name => "Main.hx", :line_number => 130, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  3.14 -> #{truncated1}", %{:file_name => "Main.hx", :line_number => 131, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  3.99 -> #{truncated2}", %{:file_name => "Main.hx", :line_number => 132, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  -2.5 -> #{truncated3}", %{:file_name => "Main.hx", :line_number => 133, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  -2.1 -> #{truncated4}", %{:file_name => "Main.hx", :line_number => 134, :class_name => "Main", :method_name => "testRandomAndInt"})
    Log.trace("  0.0 -> #{truncated5}", %{:file_name => "Main.hx", :line_number => 135, :class_name => "Main", :method_name => "testRandomAndInt"})
  end
end