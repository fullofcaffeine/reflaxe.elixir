defmodule StringTools do
  ...
  if (acc_buf.length + acc_s.length < acc_l), do: {:cont, {acc_s, acc_buf <> c, acc_l, acc_state}}, else: {:halt, {acc_s, acc_buf, acc_l, acc_state}}
end)
    buf <> s
  end
  def rpad(s, c, l) do
  ...
  if (acc_buf.length < acc_l), do: {:cont, {acc_l, acc_buf <> c, acc_state}}, else: {:halt, {acc_l, acc_buf, acc_state}}
end)
    buf
  end
