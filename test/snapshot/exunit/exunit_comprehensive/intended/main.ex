defmodule Main do
  ...
  :nomatch -> -1
    ...
    _ = Assert.equals("Hello", parts[0], "First part should be 'Hello'")
    _ = Assert.equals("World!", parts[1], "Second part should be 'World!'")
  end
  test "array operations" do
    arr = [1, 2, 3, 4, 5]
    _ = Assert.equals(5, length(arr), "Array length should be 5")
    _ = Assert.equals(1, arr[0], "First element should be 1")
    _ = Assert.equals(5, arr[4], "Last element should be 5")
    doubled = Enum.map(arr, fn x -> x * 2 end)
    _ = Assert.equals(5, length(doubled), "Mapped array should have same length")
    _ = Assert.equals(2, doubled[0], "First element should be doubled")
    _ = Assert.equals(10, doubled[4], "Last element should be doubled")
    evens = Enum.filter(arr, fn x -> rem(x, 2) == 0 end)
    _ = Assert.equals(2, length(evens), "Should have 2 even numbers")
    _ = Assert.equals(2, evens[0], "First even should be 2")
    _ = Assert.equals(4, evens[1], "Second even should be 4")
  ...
  test "mocking patterns" do
    ...
    _ = Assert.equals("getData(123)", mock_calls[0], "First call should be getData")
    _ = Assert.equals("saveData(456, test)", mock_calls[1], "Second call should be saveData")
  end
end
