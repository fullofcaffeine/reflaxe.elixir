defmodule TableBuilder do
  def new(name, options_param \\ nil) do
  ...
  def add_foreign_key(struct, column_name, referenced_table, options_param \\ nil) do
  ...
  def add_index(struct, columns_param, options_param \\ nil) do
    %{struct | indexes: struct.indexes ++ [%{columns: columns_param, options: options_param}]}
  end
  def add_unique_constraint(struct, columns_param, name \\ nil) do
