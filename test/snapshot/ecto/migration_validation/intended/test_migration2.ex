defmodule TestMigration2 do
  def up(struct) do
    ...
    reflaxe_dispatch_receiver = _ = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "post_id", {:integer}, nil])
    _ = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_index, [reflaxe_dispatch_receiver, ["content"], %{unique: false}])
  end
  def down(struct) do
