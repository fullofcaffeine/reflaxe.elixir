defmodule TestMigration do
  def up(struct) do
    ...
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "name", {:string}, %{nullable: false}])
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "email", {:string}, %{nullable: false}])
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_timestamps, [reflaxe_dispatch_receiver])
    apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_index, [reflaxe_dispatch_receiver, ["email"], %{unique: true}])
    reflaxe_dispatch_receiver = apply(Map.get(struct, :__reflaxe_class__) || Map.get(struct, :__struct__), :create_table, [struct, "posts", nil])
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "id", {:integer}, %{primary_key: true, auto_generate: true}])
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "title", {:string}, %{nullable: false}])
    ...
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_column, [reflaxe_dispatch_receiver, "author_id", {:integer}, nil])
    reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_timestamps, [reflaxe_dispatch_receiver])
    apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :add_foreign_key, [reflaxe_dispatch_receiver, "author_id", "users", nil])
  end
  def down(struct) do
