...
class TestMigration extends Migration {
	public function up():Void {
		// Create first table
		createTable("users").addColumn("id", ColumnType.Integer, {primaryKey: true, autoGenerate: true})
		...
		createTable("posts").addColumn("id", ColumnType.Integer, {primaryKey: true, autoGenerate: true})
...
class TestMigration2 extends Migration {
	public function up():Void {
		createTable("comments").addColumn("id", ColumnType.Integer, {primaryKey: true, autoGenerate: true})
			.addColumn("content", ColumnType.Text)
