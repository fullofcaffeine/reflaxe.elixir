defmodule SslSocket do
  ...
  def accept(struct) do
    ...
    SslSocketState.attach(socket.socket_ref, accepted, struct.verify_cert, struct.ca_cert, struct.own_certificate, struct.own_key)
    socket
  end
