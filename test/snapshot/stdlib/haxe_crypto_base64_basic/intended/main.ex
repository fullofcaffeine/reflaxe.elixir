defmodule Main do
  ...
  def main() do
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_0 = Haxe.Crypto.Base64.decode("aGVsbG8=", nil)
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_1 = Haxe.Crypto.Base64.decode("aGVsbG8", false)
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_2 = Haxe.Crypto.Base64.url_decode("Zm8_", nil)
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_3 = Haxe.Crypto.Base64.url_decode("Zm8=", true)
