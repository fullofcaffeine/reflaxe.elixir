defmodule Main do
  ...
  def main() do
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_0 = Digest.make(Bytes.of_string("abc", {:utf8}), "MD5")
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_1 = Digest.make(Bytes.of_string("abc", {:utf8}), "SHA1")
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_2 = Digest.make(Bytes.of_string("abc", {:utf8}), "SHA224")
      apply(Map.get(reflaxe_dispatch_receiver_node_2, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver_node_2, :__struct__), :to_hex, [reflaxe_dispatch_receiver_node_2])
    end).() == "23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7", "SHA224 digest should match the standard vector")
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_3 = Digest.make(Bytes.of_string("abc", {:utf8}), "SHA256")
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_4 = Digest.make(Bytes.of_string("abc", {:utf8}), "SHA384")
      apply(Map.get(reflaxe_dispatch_receiver_node_4, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver_node_4, :__struct__), :to_hex, [reflaxe_dispatch_receiver_node_4])
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_5 = Digest.make(Bytes.of_string("abc", {:utf8}), "SHA512")
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver_node_6 = Digest.make(Bytes.of_string("abc", {:utf8}), "RIPEMD160")
      apply(Map.get(reflaxe_dispatch_receiver_node_6, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver_node_6, :__struct__), :to_hex, [reflaxe_dispatch_receiver_node_6])
