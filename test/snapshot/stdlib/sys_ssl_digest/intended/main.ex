defmodule Main do
  ...
  defp reject_unsupported_sign() do
    try do
      Digest.sign(Bytes.of_string("abc", {:utf8}), nil, "SHA256")
  ...
  def main() do
    ...
    assert_that(apply(Map.get(digest, :__reflaxe_class__) || Map.get(digest, :__struct__), :to_hex, [digest]) == "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad", "SHA256 digest should match :crypto.hash output")
    reject_unsupported_sign()
  end
end
