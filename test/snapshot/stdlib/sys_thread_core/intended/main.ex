defmodule Main do
  def main() do
    ...
    apply(Map.get(current, :__reflaxe_class__) || Map.get(current, :__struct__), :send_message, [current, "self-message"])
    ...
    apply(Map.get(deque, :__reflaxe_class__) || Map.get(deque, :__struct__), :add, [deque, "tail"])
    apply(Map.get(deque, :__reflaxe_class__) || Map.get(deque, :__struct__), :push, [deque, "head"])
    ...
    Sys.Thread.Thread.create(fn ->
      apply(Map.get(blocking_deque, :__reflaxe_class__) || Map.get(blocking_deque, :__struct__), :add, [blocking_deque, "from-child"])
      apply(Map.get(mailbox, :__reflaxe_class__) || Map.get(mailbox, :__struct__), :send_message, [mailbox, "child-finished"])
    end)
    ...
    Sys.Thread.Tls.set_value(tls, "main")
    tls_mailbox = Sys.Thread.Thread.current()
    Sys.Thread.Thread.create(fn ->
      Sys.Thread.Tls.set_value(tls, "child")
      apply(Map.get(tls_mailbox, :__reflaxe_class__) || Map.get(tls_mailbox, :__struct__), :send_message, [tls_mailbox, Sys.Thread.Tls.get_value(tls)])
    end)
    ...
    apply(Map.get(loop, :__reflaxe_class__) || Map.get(loop, :__struct__), :run, [loop, fn -> apply(Map.get(loop_mailbox, :__reflaxe_class__) || Map.get(loop_mailbox, :__struct__), :send_message, [loop_mailbox, "loop-ran"]) end])
