defmodule Main do
  ...
  def main() do
    _ = assert_that(Haxe.Crypto.Crc32.make(Bytes.of_string("", {:utf8})) == 0, "crc32 empty failed")
    _ = assert_that(Haxe.Crypto.Crc32.make(Bytes.of_string("abc", {:utf8})) == 891568578, "crc32 abc failed")
    ...
    _ = assert_that(Haxe.Crypto.Adler32.make(Bytes.of_string("", {:utf8})) == 1, "adler32 empty failed")
    _ = assert_that(Haxe.Crypto.Adler32.make(Bytes.of_string("abc", {:utf8})) == 38600999, "adler32 abc failed")
