defmodule Main do
  ...
  def main() do
    ...
    _ = assert_that(wrapped_add == 0, "UInt wrap-around add failed")
    wrapped_mul = (
    ...
    _ = assert_that(wrapped_mul == -2, "UInt wrap-around mul failed")
    shifted = (
    ...
    _ = assert_that(shifted == 2147483647, "UInt unsigned shift-right failed")
    _ = assert_that((fn ->
    a_neg = all_ones < 0
    b_neg = false
    ...
    _ = assert_that(not_zero == -1, "UInt bitwise not failed (~0)")
    ten = 10
    five = 5
    _ = assert_that((fn ->
    a = (
