defmodule HttpBase do
  ...
  def request(_struct, _post \\ nil) do
  ...
  def success(struct, data) do
    HttpBaseRuntime.set_response_bytes(struct.http_base_ref, data)
    HttpBaseRuntime.call_on_data(struct, get_response_data(struct))
