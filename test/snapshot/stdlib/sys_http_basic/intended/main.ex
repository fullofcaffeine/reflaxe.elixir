defmodule Main do
  ...
  defp test_callbacks_and_headers() do
    ...
    assert_that(get_callback_int("sys_http_status") == 200, "GET should report status 200")
    assert_that(get_callback_string("sys_http_data") == "get-ok", "GET should call onData")
