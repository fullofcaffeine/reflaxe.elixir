defmodule Main do
  ...
  def main() do
    ...
    assert_that((fn ->
      ...
      reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :make, [reflaxe_dispatch_receiver, empty, empty])
    ...
    assert_that((fn ->
      reflaxe_dispatch_receiver = Haxe.Crypto.Hmac.new({:md5})
      reflaxe_dispatch_receiver = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :make, [reflaxe_dispatch_receiver, key, msg])
      apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :to_hex, [reflaxe_dispatch_receiver])
