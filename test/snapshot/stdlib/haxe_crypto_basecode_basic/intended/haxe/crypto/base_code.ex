defmodule Haxe.Crypto.BaseCode do
  ...
  def encode_string(struct, s) do
    reflaxe_dispatch_receiver = apply(Map.get(struct, :__reflaxe_class__) || Map.get(struct, :__struct__), :encode_bytes, [struct, Bytes.of_string(s, nil)])
  ...
  def decode_string(struct, s) do
    reflaxe_dispatch_receiver = apply(Map.get(struct, :__reflaxe_class__) || Map.get(struct, :__struct__), :decode_bytes, [struct, Bytes.of_string(s, nil)])
    _ = apply(Map.get(reflaxe_dispatch_receiver, :__reflaxe_class__) || Map.get(reflaxe_dispatch_receiver, :__struct__), :to_string, [reflaxe_dispatch_receiver])
  end
  def encode(s, base_param) do
    b = Haxe.Crypto.BaseCode.new(Bytes.of_string(base_param, nil))
