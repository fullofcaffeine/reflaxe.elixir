...
Main.main = function() {
	...
	var hook = { el : null, pushEvent : function(event,payload) {
		pushed.push(event + ":" + (payload == null ? null : ((p,k)=>{var v=p[k]; return (typeof v==='string') ? v : null;})(payload,"message")) + ":" + (payload == null ? null : ((p,k)=>{var v=p[k]; return (typeof v==='string') ? v : null;})(payload,"copied_at")));
	}};
...
ProfileHookEvents.encode = function(event) {
	...
	case 0:
		...
		var wire = { };
		var copiedAt = payload.copiedAt;
		if(wire != null) {
			wire["copied_at"] = copiedAt;
		}
...
ProfileHookEvents.decode = function(eventName,payload) {
	if(eventName == "clipboard_copied") {
		var copiedAt = payload == null ? null : ((p,k)=>{var v=p[k]; return (typeof v==='string') ? v : null;})(payload,"copied_at");
