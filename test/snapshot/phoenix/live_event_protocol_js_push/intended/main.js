...
var ProfileHookEvent = $hxEnums["ProfileHookEvent"] = { __ename__:true,__constructs__:null
	,ClipboardCopied: ($_=function(message) { return {_hx_index:0,message:message,__enum__:"ProfileHookEvent",toString:$estr}; },$_._hx_name="ClipboardCopied",$_.__params__ = ["message"],$_)
