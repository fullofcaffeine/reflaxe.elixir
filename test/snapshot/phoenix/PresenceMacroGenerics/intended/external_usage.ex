defmodule ExternalUsage do
  def test_external_methods() do
    meta = %{online_at: DateTime.to_unix(DateTime.utc_now(), :millisecond), user_name: "John"}
    TestApp.Presence.track(self(), "presence:test", "user123", meta)
    meta = %{online_at: DateTime.to_unix(DateTime.utc_now(), :millisecond), user_name: "John", status: "away"}
