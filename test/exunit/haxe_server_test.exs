defmodule HaxeServerTest do
  ...
  describe "start_link/1" do
    ...
    test "attaches to cookie port when env port is occupied" do
      ...
      {resolved_haxe_exe, resolved_haxe_args} =
        HaxeServer.resolve_haxe_cmd(haxe_exe, [], project_root)
      ...
      try do
        ...
        assert {:ok, _pid} =
                 HaxeServer.start_link(haxe_cmd: {resolved_haxe_exe, resolved_haxe_args})
    ...
    test "last_compile timestamp updates after compilation" do
      ...
      case {stats1.status, stats2.last_compile} do
        ...
        _ ->
          ...
          assert stats2.last_compile == initial_timestamp or
                   is_struct(stats2.last_compile, DateTime)
      end
    end
  end
