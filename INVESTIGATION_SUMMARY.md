...
### Affected Files:
- `/REDACTED_LOCAL_PATH` (source)
- `/REDACTED_LOCAL_PATH` (generated, broken)

### Related Documentation:
- `/REDACTED_LOCAL_PATH` - Known Issues section
- `/REDACTED_LOCAL_PATH` - Similar bug patterns
...
**Complete Investigation Report**: See `/REDACTED_LOCAL_PATH`
