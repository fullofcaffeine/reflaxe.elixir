...
| 4 | `BundleCoreTransforms` | `core-lowering` | `mixed` | `core-lowering.mixed` | source order | Core idiom, control-flow, collection, and runtime lowering (223 child passes) |
...
| 7 | `BundleAbsoluteFinal` | `absolute-final` | `mixed` | `absolute-final.mixed` | source order | Absolute-final validation and narrowly scoped cleanup (183 child passes) |
