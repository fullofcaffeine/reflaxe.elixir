...
| 4 | `BundleCoreTransforms` | `core-lowering` | `mixed` | `core-lowering.mixed` | source order | Core idiom, control-flow, collection, and runtime lowering (220 child passes) |
| 5 | `BundleHeexPipeline` | `hxx-heex` | `mixed` | `hxx-heex.mixed` | source order | Typed HXX and HEEx lowering (85 child passes) |
