...
- Local std modules present: **92** (candidates scanned: 95)
- Intersection (local provides): **83**
- Missing locally (reference-only): **121**
- Local-only: **9**
...
`sys.*` (5): gaps across host/runtime integration surfaces.
