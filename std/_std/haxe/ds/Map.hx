 ...
 *
 * This file exists to keep our Elixir stdlib overrides aligned with the reference repo. The Elixir
 * backend treats map instances as native `%{}` terms and relies on AST lowering/rewrites to emit
 * idiomatic `Map.*` operations.
 */
@:transitive
