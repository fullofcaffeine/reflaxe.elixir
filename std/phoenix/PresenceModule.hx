...
class PresenceModule {
	...
	static extern inline function trackPresence<T>(socket:Socket<T>, topic:String, key:String, meta:Term):Socket<T> {
	...
	static extern inline function updatePresence<T>(socket:Socket<T>, topic:String, key:String, meta:Term):Socket<T> {
	...
	static extern inline function listPresences(topic:String):Term {
	...
	static extern inline function untrackPresence<T>(socket:Socket<T>, topic:String, key:String):Socket<T> {
