...
class FlashMapTools {
	...
	public static function hasAny(flashMap:FlashMap):Bool {
		return flashMap.info != null || flashMap.success != null || flashMap.warning != null || flashMap.error != null;
	}
	...
	public static function getAll(flashMap:FlashMap):Array<FlashMessage> {
		...
		return infoMessages.concat(successMessages).concat(warningMessages).concat(errorMessages);
	}
