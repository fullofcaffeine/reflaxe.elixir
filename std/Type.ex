defmodule Type do
  ...
  """
  def create_instance(class, args) do
  ...
  """
  def create_empty_instance(class) do
    struct(class)
  end
  ...
  """
  def create_enum(_enum_type, constructor, params \\ []) do
    tag = String.to_atom(constructor)
    List.to_tuple([tag | params])
  end
