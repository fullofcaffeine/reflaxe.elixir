...
abstract Changeset<T, P>(Term) from Term to Term {
	...
	extern inline public function validateAcceptance(field:String, ?message:String):Changeset<T, P> {
		if (message != null) {
			return untyped __elixir__('Ecto.Changeset.validate_acceptance({0}, {1}, message: {2})', this, cast(field, Atom), message);
		} else {
	...
	extern inline public function validateConfirmation(field:String, ?message:String):Changeset<T, P> {
		if (message != null) {
			return untyped __elixir__('Ecto.Changeset.validate_confirmation({0}, {1}, message: {2})', this, cast(field, Atom), message);
		} else {
	...
	extern inline public function uniqueConstraint(field:String, ?opts:{?name:String, ?message:String}):Changeset<T, P> {
		if (opts != null) {
			if (opts.name != null && opts.message != null) {
				return untyped __elixir__('Ecto.Changeset.unique_constraint({0}, {1}, [name: {2}, message: {3}])', this, cast(field, Atom), opts.name,
					opts.message);
			} else if (opts.name != null) {
				return untyped __elixir__('Ecto.Changeset.unique_constraint({0}, {1}, [name: {2}])', this, cast(field, Atom), opts.name);
			} else if (opts.message != null) {
				return untyped __elixir__('Ecto.Changeset.unique_constraint({0}, {1}, [message: {2}])', this, cast(field, Atom), opts.message);
			} else {
	...
	extern inline public function foreignKeyConstraint(field:String, ?opts:{?name:String, ?message:String}):Changeset<T, P> {
		if (opts != null) {
			if (opts.name != null && opts.message != null) {
				return untyped __elixir__('Ecto.Changeset.foreign_key_constraint({0}, {1}, [name: {2}, message: {3}])', this, cast(field, Atom), opts.name,
					opts.message);
			} else if (opts.name != null) {
				return untyped __elixir__('Ecto.Changeset.foreign_key_constraint({0}, {1}, [name: {2}])', this, cast(field, Atom), opts.name);
			} else if (opts.message != null) {
				return untyped __elixir__('Ecto.Changeset.foreign_key_constraint({0}, {1}, [message: {2}])', this, cast(field, Atom), opts.message);
			} else {
	...
	extern inline public function checkConstraint(field:String, opts:{name:String, ?message:String}):Changeset<T, P> {
		if (opts.message != null) {
			return untyped __elixir__('Ecto.Changeset.check_constraint({0}, {1}, [name: {2}, message: {3}])', this, cast(field, Atom), opts.name, opts.message);
		} else {
			return untyped __elixir__('Ecto.Changeset.check_constraint({0}, {1}, [name: {2}])', this, cast(field, Atom), opts.name);
		}
	}
	...
	extern inline public function addError(field:String, message:String, ?opts:Term):Changeset<T, P> {
		if (opts != null) {
			return untyped __elixir__('Ecto.Changeset.add_error({0}, {1}, {2}, {3})', this, cast(field, Atom), message, opts);
		} else {
			return untyped __elixir__('Ecto.Changeset.add_error({0}, {1}, {2})', this, cast(field, Atom), message);
		}
	}
