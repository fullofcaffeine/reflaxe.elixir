...
class TableBuilder {
	...
	public function addColumn<T>(name:String, type:ColumnType<T>, ?options:ColumnOptions<T>):TableBuilder {
		...
		reflaxe.elixir.macros.MigrationRegistry.registerColumn(tableName, name, typeStr, nullable, haxe.macro.Context.currentPos());
		#end
	...
	public function addForeignKey(columnName:String, referencedTable:String, ?options:ReferenceOptions):TableBuilder {
		...
		reflaxe.elixir.macros.MigrationRegistry.validateTableExistsDeferred(referencedTable, haxe.macro.Context.currentPos());

		// Also validate that the column we're creating exists
		reflaxe.elixir.macros.MigrationRegistry.validateColumnExists(tableName, columnName, haxe.macro.Context.currentPos());
		#end
	...
	public function addIndex(columns:Array<String>, ?options:IndexOptions):TableBuilder {
		...
		reflaxe.elixir.macros.MigrationRegistry.validateColumnsExist(tableName, columns, haxe.macro.Context.currentPos());
		#end
