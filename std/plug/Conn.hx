...
abstract Conn<TParams>(Term) from Term to Term {
	 ...
	 */
	extern public inline function getSession(key:String):Term {
	 ...
	 */
	extern public inline function putSession(key:String, value:Term):Conn<TParams> {
	 ...
	 */
	extern public inline function deleteSession(key:String):Conn<TParams> {
	 ...
	 */
	extern public inline function configureSession(opts:Term):Conn<TParams> {
	 ...
	 */
	extern public inline function json(data:Term):Conn<TParams> {
	 ...
	 */
	extern public inline function render(template:String, ?assigns:Term):Conn<TParams> {
	 ...
	 */
	extern public inline function redirect(to:String):Conn<TParams> {
	 ...
	 */
	extern public inline function redirectExternal(url:String):Conn<TParams> {
	 ...
	 */
	extern public inline function putStatus(status:Int):Conn<TParams> {
	 ...
	 */
	extern public inline function putFlash(kind:String, message:String):Conn<TParams> {
	 ...
	 */
	extern public inline function assign(key:Atom, value:Term):Conn<TParams> {
	 ...
	 */
	extern public inline function sendResp(status:Int, body:String):Conn<TParams> {
	 ...
	 * @return Halted conn
	 */
	extern public inline function halt():Conn<TParams> {
