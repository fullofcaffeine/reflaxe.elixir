 ...
 *
 * This helper is target-owned, so its Haxe module uses the compiler namespace.
 * Its native Elixir module uses the same target-owned namespace.
 */
@:native("Reflaxe.Elixir.Runtime.TimerRuntime")
@:keep
@:noCompletion
class TimerRuntime {
	@:keep
	...
	public static function storeCallback(ref:Term, callback:Void->Void):Void {
		untyped __elixir__('(
            if {0} != nil do
              :ets.insert(Reflaxe.Elixir.Runtime.TimerRuntime.table(), {{0}, {1}})
            end
            :ok
        )', ref, callback);
	}
	...
	public static function invoke(ref:Term, fallback:Void->Void):Void {
		untyped __elixir__('Reflaxe.Elixir.Runtime.TimerRuntime.get({0}, {1}).()', ref, fallback);
	}
	...
	public static function delete(ref:Term):Void {
		untyped __elixir__('(
            if {0} != nil do
              :ets.delete(Reflaxe.Elixir.Runtime.TimerRuntime.table(), {0})
            end
            :ok
        )', ref);
	}
