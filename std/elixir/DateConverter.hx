...
/**
 * Converts between Haxe dates and Elixir date types.
 *
 * This target-owned helper supports `Date`, `ElixirDate`, `ElixirDateTime`,
 * and `NaiveDateTime` values.
 * 
 * ## Usage Examples
 * 
 * ```haxe
 ...
 * var elixirDate = elixir.DateConverter.toElixirDate(haxeDate);
 * 
 * // Convert Elixir DateTime to Haxe Date
 * var elixirDateTime = ElixirDateTime.utc_now();
 * var haxeDate = elixir.DateConverter.fromDateTime(elixirDateTime);
 * 
 * // Format date for display
 * var formatted = elixir.DateConverter.formatDate(haxeDate, "YYYY-MM-DD");
 * ```
 */
class DateConverter {
	// ========================================
