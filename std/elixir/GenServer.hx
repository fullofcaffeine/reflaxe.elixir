...
extern class GenServer {
	...
	@:native("GenServer.multi_call")
	public static function multiCallWithTimeout<Req, Res>(nodes:Array<String>, name:String, request:Req,
		timeout:Int):{replies:Array<{node:String, reply:Res}>, badNodes:Array<String>};
