...
extern class NaiveDateTime {
	 ...
	 */
	static function new_datetime(year:Int, month:Int, day:Int, hour:Int, minute:Int, second:Int,
		?microsecond:{value:Int, precision:Int}):haxe.functional.Result<NaiveDateTime, String>;
