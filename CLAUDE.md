...
- **Haxe source code** - The Haxe compiler source at `/REDACTED_LOCAL_PATH` for API reference
...
- **Haxe API documentation** - Can check API at `/REDACTED_LOCAL_PATH` for standard library
...
Based on analysis of `/REDACTED_LOCAL_PATH`:
...
- **Architecture Validation Rule** - Occasionally reference the Reflaxe source code and reference implementations in `/REDACTED_LOCAL_PATH` to ensure our architecture follows established Reflaxe patterns and isn't diverging too far from proven approaches
...
- **Reference Codebase**: `/REDACTED_LOCAL_PATH` - Contains Reflaxe patterns, Phoenix examples, Haxe source
...
5. **Use reference folder** - Check `/REDACTED_LOCAL_PATH` for modern implementations
