...
class OutputManager {
	...
	**/
	public function saveFile(path: String, content: StringOrBytes) {
		 ...
		 * - Legitimate: "/REDACTED_LOCAL_PATH", "/tmp/cache.ex", "/home/user/output.ex"
		 ...
		 * - "/REDACTED_LOCAL_PATH" → Real absolute path → "/REDACTED_LOCAL_PATH" (preserved)
		 ...
		 * 2. Check if it looks like a real absolute path (/REDACTED_LOCAL_PATH /tmp/, /var/, etc.)
