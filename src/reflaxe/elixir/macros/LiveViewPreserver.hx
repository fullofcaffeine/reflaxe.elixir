		...
		for (type in types) {
			switch (type) {
				case TClassDecl(classRef):
					...
					if (cls.meta.has(":controller") || cls.meta.has(":channel") || cls.meta.has(":endpoint") || cls.meta.has(":router")
						|| cls.meta.has(":presence") || cls.meta.has(":socket") || cls.meta.has(":component") || cls.meta.has(":phoenix.components")) {
