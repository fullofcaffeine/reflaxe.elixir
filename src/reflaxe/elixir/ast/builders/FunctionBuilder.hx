...
class FunctionBuilder {
	 ...
	 */
	static function processParameter(arg:{v:TVar, value:Null<TypedExpr>}, body:Null<TypedExpr>, context:CompilationContext,
	...
	static function applyParameterRenaming(ast:ElixirAST, renaming:Map<String, String>):ElixirAST {
		...
		var def = switch (ast.def) {
			...
			case EIf(cond, then, els):
				EIf(applyParameterRenaming(cond, renaming), applyParameterRenaming(then, renaming), applyParameterRenaming(els, renaming));
