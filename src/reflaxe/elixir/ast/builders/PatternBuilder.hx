...
class PatternBuilder {
	 ...
	 */
	public static function createEnumBindingPlan(caseExpr:TypedExpr, extractedParams:Array<String>, enumType:Null<EnumType>,
	 ...
	 */
	private static function convertEnumFieldPattern(ef:EnumField, args:Array<TypedExpr>, isIdiomatic:Bool, context:BuildContext):EPattern {
		if (isIdiomatic) {
	 ...
	 */
	private static function convertIdiomaticEnumPattern(ef:EnumField, args:Array<TypedExpr>, context:BuildContext):EPattern {
	 ...
	 */
	private static function convertRegularEnumPattern(ef:EnumField, args:Array<TypedExpr>, context:BuildContext):EPattern {
	...
	public static function convertIdiomaticEnumPatternWithExtraction(value:TypedExpr, enumType:EnumType, ef:EnumField, extractedParams:Array<String>,
	...
	public static function convertRegularEnumPatternWithExtraction(value:TypedExpr, enumType:EnumType, ef:EnumField, extractedParams:Array<String>,
			context:BuildContext):EPattern {
	 ...
	 */
	private static function convertEnumConstructorWithExtraction(e:TypedExpr, el:Array<TypedExpr>, extractedParams:Array<String>,
			context:BuildContext):EPattern {
	 ...
	 */
	private static function convertEnumFieldWithExtraction(ef:EnumField, extractedParams:Array<String>, enumType:EnumType, context:BuildContext):EPattern {
	...
	public static function isEmptyCaseBody(body:ElixirAST):Bool {
		...
		return switch (body.def) {
			case EAtom(a): a == "nil";
			case ENil: true;
			case EBlock(exprs): exprs.length == 0 || (exprs.length == 1 && isEmptyCaseBody(exprs[0]));
			default: false;
		};
	}
	 ...
	 */
	public static function updateMappingForUnderscorePrefixes(pattern:EPattern, originalMapping:Map<Int, String>,
			extractedParams:Array<String>):Map<Int, String> {
