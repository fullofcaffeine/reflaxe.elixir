...
class EnumHandler {
	 ...
	 */
	public static function generateEnumReduce(arrayExpr:ElixirAST, itemVar:String, accVar:String, initialValue:ElixirAST, body:ElixirAST,
	 ...
	 */
	public static function createEnumBindingPlan(caseExpr:TypedExpr, extractedParams:Array<String>, enumType:Null<EnumType>, context:BuildContext):{
	 ...
	 */
	public static function convertIdiomaticEnumPattern(value:TypedExpr, enumType:EnumType, extractedParams:Array<String>, context:BuildContext):EPattern {
	 ...
	 * @return Generated pattern
	 */
	public static function convertRegularEnumPattern(value:TypedExpr, enumType:EnumType, extractedParams:Array<String>, context:BuildContext):EPattern {
		var tag = extractEnumTag(value);
		if (tag == "")
			return PWildcard;
