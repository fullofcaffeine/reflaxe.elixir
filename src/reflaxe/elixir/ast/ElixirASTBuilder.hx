        ...
        return switch(expr.expr) {
            ...
            case TField(e, fa):
                    ...
                    if (hasIdiomaticMetadata(e)) {
                        ...
                        #end
                        #if debug_ast_builder
                        var enumTypeName = switch(e.expr) {
                            case TField(_, FEnum(enumRef, _)): enumRef.get().name;
                            default: "";
                        };
                        trace('[AST Builder] Enum type: $enumTypeName');
                        #end
                    }
                    #end
                    ...
                    var patterns = if (hasEnumType && enumType != null) {
                        ...
                        if (isIdiomaticEnum) {
                            ...
                            [for (v in c.values) {
                                ...
                                PatternBuilder.convertIdiomaticEnumPatternWithExtraction(v, enumType, ef, patternParamNames, currentContext);
                            }];
                        } else {
                            ...
                            [for (v in c.values) {
                                ...
                                PatternBuilder.convertRegularEnumPatternWithExtraction(v, enumType, ef, patternParamNames, currentContext);
                            }];
                        }
                    } else {
