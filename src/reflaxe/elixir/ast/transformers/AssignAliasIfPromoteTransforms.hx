											...
											if (elseIsB) {
												...
												if (condHasA) {
													...
													out.push(makeASTWithMeta(EBinary(Match, makeASTWithMeta(EVar(a), stmts[i].metadata, stmts[i].pos),
														makeASTWithMeta(EIf(newCond, newThen, elseE), stmts[i + 1].metadata, stmts[i + 1].pos)),
											...
											if (elseIsRightVar) {
												...
												if (condReferencesLeftVar) {
													...
													output.push(makeASTWithMeta(EBinary(Match,
														...
														makeASTWithMeta(EIf(rewrittenCond, rewrittenThen, elseExpr), statements[index + 1].metadata,
