    ...
    return ElixirASTTransformer.transformNode(ast, function(n: ElixirAST): ElixirAST {
      return switch (n.def) {
        case EDef(name, args, guards, body):
          ...
          #if (sys && debug_varref_suffix) if (target != null) Sys.println('[VarRefSuffixParamNormalize_UltraFinal] def ' + name + ' query->' + target); #end
        ...
        case EDefp(name2, args2, guards2, body2):
          ...
          #if (sys && debug_varref_suffix) if (target2 != null) Sys.println('[VarRefSuffixParamNormalize_UltraFinal] defp ' + name2 + ' query->' + target2); #end
    ...
    return ElixirASTTransformer.transformNode(body, function(x: ElixirAST): ElixirAST {
      return switch (x.def) {
        case EVar(nm) if (nm == "query"):
          #if (sys && debug_varref_suffix) Sys.println('[VarRefSuffixParamNormalize_UltraFinal] rewrite query -> ' + paramName);
          #end
