    ...
    return ElixirASTTransformer.transformNode(ast, function(n: ElixirAST): ElixirAST {
      return switch (n.def) {
        case ECase(target, clauses):
          ...
          for (cl in clauses) {
            ...
            if (binder != null && isReserved(binder)) {
          #if debug_case_payload Sys.println('[CasePayloadAvoidReserved] reserved binder ' + binder + ' detected'); #end
              ...
              if (chosen != null) {
                #if debug_case_payload Sys.println('[CasePayloadAvoidReserved] renaming binder ' + binder + ' -> ' + chosen); #end
                var newName = chosen;
