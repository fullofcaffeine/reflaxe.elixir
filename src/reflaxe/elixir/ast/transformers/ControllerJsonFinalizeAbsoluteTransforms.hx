		...
		return ElixirASTTransformer.transformNode(node, function(n:ElixirAST):ElixirAST {
			return switch (n.def) {
				...
				case ECase(expr, clauses):
					var newClauses = [];
					for (cl in clauses)
						newClauses.push({pattern: cl.pattern, guard: cl.guard, body: fixArm(cl.pattern, cl.body)});
		...
		return ElixirASTTransformer.transformNode(body, function(n:ElixirAST):ElixirAST {
			return switch (n.def) {
				case ECase(expr, clauses):
					var out = [];
					for (cl in clauses)
						out.push({pattern: cl.pattern, guard: cl.guard, body: fixArm(cl.pattern, cl.body)});
