...
class CaseClauseAliasFromUnderscoreBinderTransforms {
  ...
  static function aliasInClause(cl: ECaseClause): ECaseClause {
    ...
    #if debug_case_alias Sys.println('[CaseAliasUnderscore] decl={' + declArr + '} used={' + usedArr + '} patU={' + patArr + '}'); #end
    #end
    ...
    #if (sys && !no_traces)
    #if debug_case_alias for (a in aliases) Sys.println('[CaseAliasUnderscore] prefix ' + a.u + ' = ' + a.from); #end
    #end
