...
class ElixirTyper {
	 ...
	 */
	public function generateFunctionSpec(funcName:String, paramTypes:Array<String>, returnType:String, ?context:TypeContext, indentLevel:Int = 1):String {
	 ...
	 */
	public function generateFunctionOverloadSpecs(funcName:String, overloads:Array<{params:Array<String>, returns:String}>, ?context:TypeContext,
			indentLevel:Int = 1):String {
		var specs = [];
	 ...
	 */
	public function generateTypeDefinition(typeName:String, fields:Array<{name:String, type:String}>, ?context:TypeContext, indentLevel:Int = 1):String {
	 ...
	 */
	public function generateUnionTypeDefinition(typeName:String, variants:Array<String>, ?context:TypeContext, indentLevel:Int = 1):String {
		var baseIndent = [for (i in 0...indentLevel) "  "].join("");
	 ...
	 */
	public function generateOpaqueTypeDefinition(typeName:String, baseType:String, ?context:TypeContext, indentLevel:Int = 1):String {
		var baseIndent = [for (i in 0...indentLevel) "  "].join("");
	...
	public function isHaxeType(typeStr:String):Bool {
		...
		if (typeStr.indexOf("String.t()") >= 0)
			return false;
		if (typeStr.indexOf("integer()") >= 0)
			return false;
	...
	private function isBuiltinGeneric(genericType:String):Bool {
		...
		for (builtin in builtins) {
			if (genericType.indexOf(builtin) == 0)
				return true;
		}
		return false;
	}
