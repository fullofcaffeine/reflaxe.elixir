...
class ElixirCompiler extends GenericCompiler<reflaxe.elixir.ast.ElixirAST, // CompiledClassType
	...
	/** Uses fail-closed, transactionally published generated output. */
	public override function createOutputManager():OutputManager {
		return new GeneratedOutputManager(this);
	}
	...
	function buildClassAST(classType:ClassType, varFields:Array<ClassVarData>, funcFields:Array<ClassFuncData>):Null<reflaxe.elixir.ast.ElixirAST> {
		...
		//   implementation under `std/elixir/_std/haxe/Exception.hx` that emits as `Reflaxe.Exception`.
...
left_name == right_name and left_params == right_params';
	...
	/**
	 * Formats or checks the complete staged output set before ownership publication.
	 *
	 * Running the formatter here means syntax/configuration failures and formatter writes
	 * cannot partially mutate the live Phoenix source tree or invalidate ownership hashes.
	 */
	public override function onOutputPrepared(outputDirectory:String) {
