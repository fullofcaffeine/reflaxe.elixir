# Haxe API Quick Reference (Auto-Generated)

This is an auto-generated reference of Haxe standard library types that are commonly used when working with Reflaxe.Elixir. For the complete and up-to-date API documentation, see https://api.haxe.org/
