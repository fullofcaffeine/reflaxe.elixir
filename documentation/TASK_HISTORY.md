...
1. **EReg.map API Confirmation**
   - Investigation of `/REDACTED_LOCAL_PATH` confirmed correct API
...
1. **Test Environment Analysis**: 
   ...
   - Error shows Haxe reading from main project's config: `/REDACTED_LOCAL_PATH classpath src/ is not a directory`
