...
@:routes([
    {name: "root", method: HttpMethod.LIVE, path: "/", controller: "TodoLive", action: "index"},
    {name: "todosIndex", method: HttpMethod.LIVE, path: "/todos", controller: "TodoLive", action: "index"},
    {name: "todosShow", method: HttpMethod.LIVE, path: "/todos/:id", controller: "TodoLive", action: "show"},
    {name: "apiUsers", method: HttpMethod.GET, path: "/api/users", controller: "UserController", action: "index"},
    {name: "createUser", method: HttpMethod.POST, path: "/api/users", controller: "UserController", action: "create"},
...
@:routes([
    ...
    {name: "createUser", method: "POST", path: "/api/users", controller: "UserController", action: "create"},
    {name: "dashboard", method: "LIVE_DASHBOARD", path: "/dev/dashboard"}
])
class TodoAppRouter {
    // Functions are auto-generated by RouterBuildMacro
    // String literals still supported but discouraged
}
```
