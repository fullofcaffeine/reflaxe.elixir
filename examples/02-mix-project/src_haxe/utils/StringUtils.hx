...
class StringUtils {
     ...
     */
    public static function processString(input: String): String {
     ...
     */
    public static function formatDisplayName(name: String): String {
     ...
     */
    public static function createSlug(text: String): String {
        if (text == null) return "";
     ...
     */
    public static function truncate(text: String, maxLength: Int = 100): String {
        if (text == null) return "";
     ...
     */
    public static function maskSensitiveInfo(text: String, visibleChars: Int = 2): String {
    ...
    static function removeExcessWhitespace(text: String): String {
        // Replace multiple whitespace characters with single space
        return new EReg("\\s+", "g").replace(text, " ");
    }
    
    static function normalizeCase(text: String): String {
    ...
    static function extractUsername(email: String): String {
        var atIndex = email.indexOf("@");
