 ...
 * across different parts of a Mix project.
  ...
  @spec main() :: nil
  def main() do
    Log.trace("StringUtils compiled successfully for Mix project!", %{fileName: "src_haxe/utils/StringUtils.hx", lineNumber: 178, className: "utils.StringUtils", methodName: "main"})
  end
