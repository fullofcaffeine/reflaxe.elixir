defmodule Input do
  ...
  def read_byte(_struct) do
    raise Reflaxe.Elixir.HaxeThrow, [value: NotImplementedException.new(nil, nil, %{:file_name => "haxe/io/Input.hx", :line_number => 38, :class_name => "haxe.io.Input", :method_name => "readByte"})]
  end
