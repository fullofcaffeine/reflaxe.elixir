(() => {
  ...
  // js/todo-app-haxe.js
  var require_todo_app_haxe = __commonJS({
    "js/todo-app-haxe.js"(exports) {
      (function($global) {
        "use strict";
        Math.__name__ = true;
        class Std {
        ...
        class client_SimpleTodoApp {
          ...
          static cacheForOffline(element) {
            ...
            if (todosData != null) {
              ...
              storage.setItem("todos_cache_time", Std.string((/* @__PURE__ */ new Date()).getTime()));
            }
          }
            ...
            switch (t) {
              ...
              case "object":
                if (o instanceof Array) {
                  ...
                  while (_g < _g1) {
                    let i = _g++;
                    str2 += (i > 0 ? "," : "") + js_Boot.__string_rec(o[i], s);
                  }
                  str2 += "]";
                  return str2;
                }
...
`);
  ...
  // js/app.js
  var import_todo_app_haxe = __toESM(require_todo_app_haxe());
  var csrfToken = document.querySelector("meta[name='csrf-token']").getAttribute("content");
  var haxeHooks = window.HaxeTodoHooks || {};
  var liveSocket = new LiveSocket("/live", Socket, {
    longPollFallbackMs: 2500,
    params: { _csrf_token: csrfToken },
    hooks: haxeHooks
    // Use Haxe-compiled hooks
  });
  liveSocket.connect();
