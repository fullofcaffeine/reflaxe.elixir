...
class Layouts {
     ...
     */
    @:keep public static function root(assigns: Assigns<LayoutAssigns<User, TodoLiveAssigns>>): String {
        return HXX.hxx('
            <!DOCTYPE html>
     ...
     */
    @:keep public static function app(assigns: Assigns<LayoutAssigns<User, TodoLiveAssigns>>): String {
        return HXX.hxx('
