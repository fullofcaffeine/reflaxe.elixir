...
class PingProtocol {
	...
	static final pingPayloadCodec:WireCodec<PingPayload> = WireCodecs.object1(requestIdField,
		function(requestId:String):PingPayload return {requestId: requestId}, function(payload:PingPayload):String return payload.requestId);
