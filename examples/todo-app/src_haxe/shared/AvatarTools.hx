...
class AvatarTools {
	...
	public static function initials(name:String, email:String):String {
		...
		if (trimmedName != "")
			return initialsFromName(trimmedName);

		var normalizedEmail = normalizeEmail(email);
		if (normalizedEmail != "")
			return initialsFromEmail(normalizedEmail);
	...
	public static function avatarBgClass(name:String, email:String):String {
		...
		if (seed == "")
			seed = StringTools.trim(name).toLowerCase();
		if (seed == "")
			seed = "unknown";
	...
	public static function avatarStyle(name:String, email:String, ?size:Int):String {
		...
		return url != null ? 'background-image: url(\'${url}\'); background-size: cover; background-position: center;' : "";
	}
