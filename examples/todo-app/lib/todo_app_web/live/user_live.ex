defmodule TodoAppWeb.UserLive do
  ...
  def handle_event(event, params, socket) do
    ...
    case (event) do
      "cancel" ->
        temp_result = UserLive.handle_cancel(socket)
      "delete_user" ->
        temp_result = UserLive.handle_delete_user(params, socket)
      "edit_user" ->
        temp_result = UserLive.handle_edit_user(params, socket)
      "new_user" ->
        temp_result = UserLive.handle_new_user(params, socket)
      "save_user" ->
        temp_result = UserLive.handle_save_user(params, socket)
      "search" ->
        temp_result = UserLive.handle_search(params, socket)
      _ ->
