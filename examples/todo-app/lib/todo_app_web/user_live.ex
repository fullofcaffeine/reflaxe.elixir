defmodule TodoAppWeb.UserLive do
  ...
  def handle_new_user(_socket) do
  ...
  def handle_edit_user(_user_id, _socket) do
  ...
  def handle_save_user(_params, _socket) do
  ...
  def handle_delete_user(_user_id, socket) do
  ...
  def handle_search(_search_term, _socket) do
  ...
  def get_status_class(_active) do
    if active, do: "status active", else: "status inactive"
  end
  def get_status_text(_active) do
    if active, do: "Active", else: "Inactive"
  end
  def render_user_form(_assigns) do
