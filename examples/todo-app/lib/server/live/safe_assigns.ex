defmodule SafeAssigns do
  ...
  def set_todos(_socket, _todos) do
    live_socket = socket
    Phoenix.Component.assign(live_socket, :todos, todos)
  end
  defp count_completed(_todos) do
    count = 0
    g = 0
