defmodule EnumValueMap do
  @compile [{:nowarn_unused_function, [{:_compare_args, 3}, {:_compare_arg, 3}, {:_compare, 3}]}]

  defp _compare(struct, k1, k2) do
  ...
  defp _compare_args(struct, a1, a2) do
    g = 0
    g1 = length(a1)
  ...
  defp _compare_arg(struct, v1, v2) do
