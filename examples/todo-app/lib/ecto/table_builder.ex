defmodule TableBuilder do
  ...
  def add_id(struct, name, _type) do
  ...
  def add_reference(struct, _column_name, _referenced_table, _options) do
    column_options = nil
    if (options != nil) do
  ...
  def add_foreign_key(_struct, _column_name, _referenced_table, _options) do
